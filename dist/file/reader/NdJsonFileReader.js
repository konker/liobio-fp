...
exports.ndJsonFileReader = void 0;
...
function read(dataAccessor, filePath) {
    var _this = this;
    return P.pipe(dataAccessor.getFileLineReadStream(filePath), P.TaskEither_.chain(function (fp) {
        return P.TaskEither_.tryCatch(function () { return __awaiter(_this, void 0, void 0, function () {
            var data, _a, _b, line, e_1_1;
            var e_1, _c;
 ...
 * See: http://ndjson.org/
 */
function ndJsonFileReader() {
    return {
        read: read,
    };
}
exports.ndJsonFileReader = ndJsonFileReader;
