...
exports.ndJsonFileLineReader = void 0;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            line = fp_1_1.value;
                            return [4 /*yield*/, __await(P.pipe(P.Json_.parse(line), P.Either_.mapLeft(error_1.toLibError)))];
 ...
 * See: http://ndjson.org/
 */
function ndJsonFileLineReader() {
    return {
        open: _open,
        close: FileLineReader_1.close,
    };
}
exports.ndJsonFileLineReader = ndJsonFileLineReader;
