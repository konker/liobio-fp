...
exports.defaultFileLineReader = void 0;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            line = fp_1_1.value;
                            return [4 /*yield*/, __await(P.Either_.right(line))];
 ...
 */
function defaultFileLineReader() {
    return {
        open: _open,
        close: FileLineReader_1.close,
    };
}
exports.defaultFileLineReader = defaultFileLineReader;
