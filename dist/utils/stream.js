...
exports.waitForPromiseDependentStreamPipe = exports.waitForStreamPipe = exports.readStreamToBuffer = void 0;
...
function readStreamToBuffer(readStream) {
    var readStream_1, readStream_1_1;
    var e_1, _a;
...
function waitForStreamPipe(readStream, writeStream) {
    return P.TaskEither_.tryCatch(function () {
        return new Promise(function (resolve, reject) {
            var size = 0;
            writeStream.on('data', function (data) { return (size += data.length); });
            writeStream.on('finish', function () { return resolve(size); });
            writeStream.on('error', function (err) { return reject(err); });
 ...
 */
function waitForPromiseDependentStreamPipe(readStream, writeStream) {
    return P.TaskEither_.tryCatch(function () {
        return new Promise(function (resolve, reject) {
            var size = 0;
            writeStream.on('data', function (data) { return (size += data.length); });
            ...
            if (writeStream.promise)
                writeStream.promise.then(function () { return resolve(size); }).catch(reject);
            else
                reject(Error('waitForPromiseDependentStreamPipe called without a stream promise'));
        });
    }, types_1.toErr);
}
exports.waitForPromiseDependentStreamPipe = waitForPromiseDependentStreamPipe;
