...
import { s3DataAccessor } from '../../src/accessor/S3DataAccessor';
...
const PATH_BASE = `s3://${TEST_S3_BUCKET}/`;
...
describe('S3DataAccessor', () => {
  ...
  beforeAll(async () => {
    ...
    dataAccessor = await s3DataAccessor()();
  });
  ...
  describe('listFiles', () => {
    ...
    it('should listFiles', async () => {
      ...
      const result = await P.pipe(testPath, P.Task_.of, P.TaskEither_.chain(dataAccessor.listFiles))();
      expect(result).toEqual(
        P.Either_.right(['s3://mws-test-bucket/sub1/sub1sub1', 's3://mws-test-bucket/sub1/f11.txt'])
      );
    });
  });
  ...
  describe('readFile', () => {
    ...
    it('should be correct for a file which does not exist', async () => {
      ...
      expect(result).toEqual(P.Either_.left('The specified key does not exist.'));
    });
  });
  ...
  describe('writeFile - readFile - deleteFile', () => {
    ...
    it('should function correctly', async () => {
      ...
      expect(result4).toEqual(P.Either_.left('The specified key does not exist.'));
    });
  });
  ...
  describe('createDirectory - writeFile - listFiles - removeDirectory', () => {
    ...
    it('should function correctly', async () => {
      ...
      const result3 = await P.pipe(
        ...
        P.TaskEither_.map((files) => files.includes('s3://mws-test-bucket/sub100' as Ref))
      )();
      ...
      expect(result6).toEqual(P.Either_.left('The specified key does not exist.'));
    });
  });
  ...
  describe('file writers', () => {
    describe.skip('DefaultFileWriter', () => {
      let testPath: P.Either<Err, Ref>;
      beforeAll(() => {
    ...
    describe.skip('NdJsonFileWriter', () => {
      let testPath: P.Either<Err, Ref>;
      beforeAll(() => {
